...
class Report(models.Model):
    ...
    report_type = models.CharField(max_length=20, choices=REPORT_TYPES, default='اعتداء')
    status = models.CharField(max_length=20, choices=CASE_STATUS, default='تم استلام البلاغ')
    ...
    severity = models.CharField(max_length=20, choices=SEVERITY, blank=True, null=True)
